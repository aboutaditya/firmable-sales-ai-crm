...
from sales_intelligence.backend.models import Company, CompanySignal
...
class DatabaseSyncService:
    ...
    def sync(
        ...
        *,
        ...
        run_id = run_tracker.start(run_type="sync", dataset_version=dataset_version, score_version="v1", source=source)
