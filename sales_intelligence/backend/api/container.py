...
from sales_intelligence.backend.ai.content_repository import SqlAlchemyAIOutputRepository
...
from sales_intelligence.backend.api.rate_limit import InMemoryRateLimiter
from sales_intelligence.backend.config import Settings
from sales_intelligence.backend.db.session import create_session_factory
...
from sales_intelligence.backend.repositories import PostgresCompanyRepository, PostgresQueueRepository
from sales_intelligence.backend.services.user_directory import SupabaseUserDirectory
...
def build_container(settings: Settings) -> AppContainer:
    ...
    if session_factory and settings.llm_api_key and settings.llm_base_url and settings.llm_model:
        ...
        trace_sink = JsonlTraceSink(settings.llm_trace_path)
